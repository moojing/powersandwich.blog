---
title: 'EVM OPCodes Analysis - Contract Creation'
date: '2025-02-24'
description: ''
cover: '../../../assets/solidity-logo.webp' 
tags: []
---
This article is intended to introduce how the Opcodes (Operation Code or OP Code) behind Solidity actually work in the EVM. When we write a contract, although we use Solidity, a human-readable programming language, Solidity is not for machines to read. Therefore, we need the intervention of a compiler to help us convert human natural language into machine code that can communicate with machines.
